...
import { BriefcaseBusiness, Building2, BadgeInfo, BookOpen /* NEXUS_GUIDE_V9 */, CalendarClock /* NEXUS_GROUP_SERVICES_V1 */, ContactRound, CalendarDays, ChartNoAxesCombined, ChevronDown, ChevronRight, CreditCard, FileText, LayoutDashboard, LifeBuoy, LogOut, Megaphone, Menu, Package, Scissors, Settings, ShieldCheck, ShoppingBag, ShoppingCart, Sparkles, Store, Trash2, Users, X } from 'lucide-react';
...
const sections=[{label:'Operación',items:[['/manager/dashboard','Inicio',LayoutDashboard],['/manager/appointments','Agenda',CalendarDays],['/manager/classes','Clases',CalendarClock]/* NEXUS_GROUP_SERVICES_V1 */,['/manager/clients','Clientes',Users],['/manager/services','Servicios',Scissors],['/manager/barbers','Equipo',BriefcaseBusiness],['/manager/catalog','Catálogo',ShoppingBag]]},{label:'Finanzas',items:[['/manager/revenue','Ingresos',ChartNoAxesCombined],['/manager/billing','Mis facturas',FileText],['/manager/settlements','Liquidaciones',CreditCard],['/manager/inventory','Inventario',Package]]},{label:'Abastecimiento',items:[['/manager/suppliers','Proveedores',Store],['/manager/purchase-orders','Órdenes de compra',ShoppingCart]]},{label:'Crecimiento',items:[['/manager/marketing','Marketing',Megaphone],['/manager/nexus-ai','Nexus AI',Sparkles]/* NEXUS_AI_V1 */,['/manager/business-profile','Perfil del negocio',Building2]]},{label:'Administración',items:[['/owner/access-control','Control de accesos',ShieldCheck,'owner'],['/owner/subscriptions','Suscripciones',CreditCard,'owner'],['/owner/platform-branding','Marca de Nexus',Sparkles,'owner']/* NEXUS_PLATFORM_BRANDING_V1 */,['/owner/third-party-matrix','Matriz de terceros',ContactRound,'owner'],
            ['/owner/announcements','Comunicados',Megaphone,'owner'],['/manager/support','Soporte (PQRS)',LifeBuoy],['/manager/fiscal-profile','Información fiscal',BadgeInfo],['/manager/settings','Configuración',Settings],['/account/privacy','Cuenta y privacidad',ShieldCheck]]},/* NEXUS_GUIDE_V9 */{label:'Ayuda',items:[['/manager/guia','Guía',BookOpen]]}/* NEXUS_GUIDE_V9 end */];
