...
const DashboardStats = ({ organizationId }) => {
  ...
  const cards = [
    ['Total recibido', money(financial.total_received), DollarSign, 'var(--app-primary)'],
    ...
    ['Ticket promedio', money(financial.average_ticket), ReceiptText, 'var(--app-primary)'],
