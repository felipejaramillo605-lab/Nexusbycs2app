...
export const staffIncomeAPI = {
  ...
  getTeamRanking: (params = {}) => api.get('/staff/income/team-ranking', { params }),
};
...
export const clientPortalAPI = {
  ...
  rescheduleAppointment: (appointmentId, data) => axios.post(`${API}/public/clients/appointments/${appointmentId}/reschedule`, data, { withCredentials: true }),
