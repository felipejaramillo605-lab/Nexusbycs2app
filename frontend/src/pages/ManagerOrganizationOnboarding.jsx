...
export default function ManagerOrganizationOnboarding(){
 ...
 return <MotionPage className="nexus-owner-page space-y-6">
  ...
  <SurfaceCard><form className="nexus-guided-form" onSubmit={e=>{e.preventDefault();setReview(true)}}>
   ...
   <label><FieldGuide label="Nombre de la organización" hint="Nombre visible en Nexus." example="Empresa Central" required/><input data-testid="onboarding-org-name" value={form.name} onChange={e=>set('name',e.target.value)} maxLength={180} required/></label>
   ...
   <label><FieldGuide label="Razón social" example="Empresa Central SAS" required/><input data-testid="onboarding-legal-name" value={form.fiscal_profile.legal_name} onChange={e=>setFiscal('legal_name',e.target.value)} maxLength={180} required/></label>
   <label><FieldGuide label="Nombre comercial" example="Empresa Central" optional/><input data-testid="onboarding-commercial-name" value={form.fiscal_profile.commercial_name} onChange={e=>setFiscal('commercial_name',e.target.value)} maxLength={180}/></label>
