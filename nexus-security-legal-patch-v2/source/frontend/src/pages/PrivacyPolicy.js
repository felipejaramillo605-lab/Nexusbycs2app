      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-300 mb-4">
              NO vendemos tu información personal a terceros. Compartimos tus datos únicamente con proveedores
              de servicios necesarios para operar la plataforma, bajo acuerdos de confidencialidad:
            </p>
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              <ul className="list-disc list-inside text-sm text-zinc-400 space-y-2">
                <li><strong className="text-white">Proveedor de Email (Gmail SMTP)</strong> — para enviar confirmaciones y recordatorios</li>
                <li><strong className="text-white">WhatsApp Business API</strong> — para enviar confirmaciones y recordatorios por WhatsApp (solo si el negocio lo tiene activado)</li>
                <li><strong className="text-white">Proveedor de Hosting y MongoDB Atlas</strong> — para almacenar tu información de forma segura</li>
                <li><strong className="text-white">Procesadores de pago (Wompi / Stripe)</strong> — solo si el negocio cobra suscripciones o pagos a través de la plataforma; Nexus no almacena datos de tarjetas, estos son procesados directamente por el proveedor de pago</li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-300 mb-4">
              Tienes los siguientes derechos sobre tus datos personales. Para ejercerlos, inicia sesión en tu{' '}
              <strong className="text-white">Portal de Cliente</strong> con tu número de teléfono y PIN — esto
              verifica tu identidad antes de mostrar o modificar tus datos. Si no tienes PIN, puedes crear uno
              gratis, o escribirnos directamente usando los datos de contacto al final de esta página.
            </p>
