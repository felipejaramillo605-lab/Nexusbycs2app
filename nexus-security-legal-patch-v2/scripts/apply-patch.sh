...
# Files that already exist and get modified (hash-verified before touching)
modified_files=(
  "PRIVACY_POLICY.md"
  "backend/server.py"
...
echo "Verificando contexto de archivos a modificar..."
for rel in "${modified_files[@]}"; do
  ...
  if [ "$current_hash" != "$expected_hash" ]; then
    ...
    echo ""
    echo "Esto normalmente significa que el código en Emergent es distinto al que se auditó."
